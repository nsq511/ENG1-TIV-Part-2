...
public class AchievementSystem{
     ...
     * @param logo The name of the logo image texture stored in the /Assets/Achievements directory
     */
    public static void addAchievement(String title, String description, int requiredConditionsAmount, float scoreModifier, String logo){
        ...
        Achievement achievement = new Achievement(title, description, requiredConditionsAmount, scoreModifier, new Texture(logo));
     ...
     * @param scoreModifier How to modify the score when this achievement is acquired
     */
    public static void addAchievement(String title, String description, int requiredConditionsAmount, float scoreModifier){
        AchievementSystem.addAchievement(title, description, requiredConditionsAmount, scoreModifier, missingTex);
    }
    /**
     * Adds an achievement to the system with defualt missing texture for the logo and no score modifier
     * 
     * @param title The name of the achievment 
     * @param description What the achievement is for
     * @param requiredConditionsAmount The number of conditions that must be met to acquire this achievement
    ...
    /**
     * Increments the number of conditions that have been completed for the given achievment
     * 
